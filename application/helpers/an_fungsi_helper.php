<?php
	...
	function enkripsi($ps){
		return base64_encode(openssl_encrypt($ps, "AES-256-CBC", 'cdaaptn1a', 0, "0123456789abcdef"));
	}

	function dekripsi($ps){
		return openssl_decrypt(base64_decode($ps), "AES-256-CBC", 'cdaaptn1a', 0, "0123456789abcdef");
	}
